export const ExpenseIcon = (props) => (
  ...
  >
    ...
    <path id="j" class="p" d="M5.5,31.9538l13.5429,10.4006,7.4233-5.9106" />

    <path id="k" class="p" d="M5.5,29.2851l13.5429,10.4006,7.4233-5.9106" />

    <path id="l" class="p" d="M5.6039,26.6164l13.5429,10.4006,7.4233-5.9106" />

    <path id="m" class="p" d="M5.5892,23.9478l13.5429,10.4006,7.4233-5.9106" />
